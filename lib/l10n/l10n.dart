...
class AppLocalizations {
  ...
  String get welcomeEyebrow => isArabic
      ? 'خطوتك الأولى نحو الجامعة'
  ...
  String get stepGradeTitle =>
      isArabic ? 'ما هي درجتك؟' : 'What is your grade?';
  ...
  String get stepBudgetTitle =>
      isArabic ? 'ما ميزانيتك السنوية؟' : 'What is your yearly budget?';
  ...
  String get stepLocationTitle =>
      isArabic ? 'أين تفضّل الدراسة؟' : 'Where would you like to study?';
  ...
  String get stepMajorTitle =>
      isArabic ? 'ما التخصص الذي يهمك؟' : 'What would you like to study?';
  ...
  String get locationHint =>
      isArabic ? 'مثال: القاهرة، مصر' : 'For example: Cairo, Egypt';
  String get locationLabel =>
      isArabic ? 'المدينة أو المنطقة' : 'City or region';
  String get selectAtLeastOne =>
      isArabic ? 'اختر تخصصاً واحداً على الأقل' : 'Select at least one major';
  String get summaryTitle =>
      isArabic ? 'لقد أصبحنا جاهزين!' : 'You are all set!';
  ...
  String get selectedMajors =>
      isArabic ? 'التخصصات المختارة' : 'Selected majors';
  String get searchUniversities =>
      isArabic ? 'ابحث عن جامعات' : 'Search universities';
  String get findUniversity => isArabic ? 'ابحث عن جامعة' : 'Find a university';
  String get filterMajor => isArabic ? 'التخصص' : 'Major';
  String get filterLocation => isArabic ? 'الموقع' : 'Location';
  String get filterBudget => isArabic ? 'الميزانية' : 'Budget';
  String get filterScholarship => isArabic ? 'منحة' : 'Scholarship';
  String get filterDeadline => isArabic ? 'الموعد النهائي' : 'Deadline';
